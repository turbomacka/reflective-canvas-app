...
export default function Admin() {
  ...
  const edit = async (s: string) => {
    ...
    if (data) {
      ...
      // Set page URL and iframe for convenience
  ...
  // Insert link at cursor into HTML
  const insertLink = () => {
          ...
          {summary && (
            <section className="mt-4">
              ...
              {summaryLoading ? (
                ...
                <div className="p-2 border rounded whitespace-pre-line">
                  {summary}
                </div>
              )}
            </section>
